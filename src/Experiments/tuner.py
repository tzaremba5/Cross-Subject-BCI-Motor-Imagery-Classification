...
def model_builder(hp):
    ...
    hp_r1 = hp.Float('Dropout Rate',min_value=0.1,max_value=0.9,default=0.2,step=0.05)
    a3 = 'sigmoid'
    ...
    (hp_p1x, hp_p1y), hp_f2, (hp_k2x, hp_k2y), hp_a2, hp_units1, hp_r1, a3, o1, l1, m1)
    return model
...
if __name__ == '__main__':
    ...
    with open(f'./tuner_results/{competition}_{subject}_best_model.json', 'w') as outfile:
