...
if __name__ == '__main__':
    ...
    for competition in competition_names:
        for subject in competitions[competition]['subjects']:
            try:
                ...
                print(f'Single trial not tests complete for {subject} in competition {competition}')
            ...
            try:
                ...
                print(f'CSWD tests not complete for {subject} in competition {competition}')
            ...
            try:
                ...
                print(f'CSCD tests not complete for {subject} in competition {competition}')
    ...
    dict_single_trial = {labels[0]:labels[1:], 
